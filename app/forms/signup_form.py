...
class SignUpForm(FlaskForm):
    first_name = StringField('first_name', validators=[DataRequired("First name required")])
    last_name = StringField('last_name', validators=[DataRequired("Last name required")])
